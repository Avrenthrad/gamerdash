// Riftbound — Deck Builder. Just a named list of cards, no format/
// legality checking and no anchor-card concept — no confirmed banlist
// API exists for a game this new (see lib/riftboundCollection.js).

import { useEffect, useState } from "react";
import { searchRiftboundCards } from "../lib/riftbound";
import {
  fetchDecks, createDeck, deleteDeck, updateDeck,
  fetchDeckCards, addCardToDeck, updateDeckCardQuantity, removeCardFromDeck,
} from "../lib/riftboundCollection";

export default function RiftboundDeckBuilderPage({ onBack, userId }) {
  ...
  async function handleAddSearch(e) {
    ...
    try {
      const cards = await searchRiftboundCards(addQuery.trim());
    ...
    return (
      <div className="price-page">
        <div className="price-page__head">
          ...
          <p className="price-page__subtitle">{totalCards} cards</p>
  ...
  return (
    <div className="price-page">
      <div className="price-page__head">
        ...
        <p className="price-page__subtitle">Real card data via Riftcodex — no format/legality checking yet.</p>
      </div>
